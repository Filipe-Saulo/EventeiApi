...
namespace Api.Repository
{
    public class AuthManagerRepository :IAuthManagerRepository
    {
        ...
        private const string _loginProvider = "EventeiApi";
        private const string _refreshToken = "RefreshToken";

        public AuthManagerRepository(IMapper mapper, UserManager<User> userManager, IConfiguration configuration, ILogger<AuthManagerRepository> logger)
        {
            _mapper = mapper;
